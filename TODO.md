...
- [ ] Remove insecure hardcoded default admin password insertion (admin123) and add safe first-run behavior.
- [ ] Replace calculator `eval()` usage with a safe expression evaluator.
